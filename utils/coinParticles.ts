...
export const createCoinParticle = (x: number, y: number, crystals: number): CrystalParticle => {
  return {
...
export const updateCoinParticles = (particles: CrystalParticle[]): CrystalParticle[] => {
