      ...
      <div className="bg-black/80 backdrop-blur-sm border border-purple-500/30 rounded-lg p-4 sm:p-8 text-center hover:border-purple-500/50 transition-colors w-full max-w-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="bg-black/40 border border-purple-500/20 rounded p-3 sm:p-4">
            <div className="text-purple-400 font-mono text-xs sm:text-sm">CREATURES DEFEATED</div>
            <div className="text-2xl sm:text-3xl font-bold text-white font-mono">{score}</div>
          </div>
          <div className="bg-black/40 border border-purple-500/20 rounded p-3 sm:p-4">
            <div className="text-purple-400 font-mono text-xs sm:text-sm">CRYSTALS</div>
          ...
          <div className="bg-black/40 border border-purple-500/20 rounded p-3 sm:p-4">
            <div className="text-purple-400 font-mono text-xs sm:text-sm">WAVE REACHED</div>
            <div className="text-2xl sm:text-3xl font-bold text-white font-mono">{currentWave}</div>
          </div>
        </div>
