...
export const metadata: Metadata = {
  ...
  description: 'Embark on an epic magical adventure! Defend the mystical realm as a powerful wizard against infinite waves of mythological creatures. Master ancient spells, collect magical crystals, and prove your worth on the global leaderboards in this stunning pixel art fantasy experience.',
  keywords: [
    'mystic realm',
    'fantasy game',
    'magic game',
  ...
  openGraph: {
    ...
    description: 'Step into the mystical realm and unleash your magical powers! Battle endless waves of mythological creatures, master powerful spells, and become the ultimate realm defender in this captivating pixel art fantasy game.',
  ...
  twitter: {
    ...
    description: 'Unleash your magical powers and defend the mystical realm! Experience the ultimate pixel art fantasy survival game.',
    images: ['/og.png'],
    creator: '@0xDecker',
  },
  ...
  other: {
    ...
    'game:credits:description': 'Meet the talented developers who brought this magical realm to life during an epic 24-hour hackathon adventure.',
    'game:leaderboard': `${siteUrl}/leaderboard`,
    'game:leaderboard:title': '🏆 Hall of Legends - MYSTIC REALM DEFENDER',
    'game:leaderboard:description': 'Ascend to legendary status! Compete with wizards worldwide and etch your name in the mystical hall of fame.',
...
export const jsonLd = {
  ...
  description: 'Embark on an epic magical adventure! Defend the mystical realm as a powerful wizard against infinite waves of mythological creatures in this stunning pixel art fantasy experience.',
